...
class GOMethod:
    ...
    def printRow_Col(self,file_arg,GO_hash): 
       ...
       rownames = gene_list
       colnames = comb_go
       self.printRow(file_str,rownames)
    ...
    def modelOrgParserPT(self, file_arg, col_ind1, col_ind2, file_out,
       ...
       file_str = self.file_out+'_preprocess_file.txt'
       try:
       ...
       # instead of writing it to a file. This could be a parameter         
